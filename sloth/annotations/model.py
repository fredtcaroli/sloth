...
from PyQt5.QtCore import QItemSelectionModel, QSortFilterProxyModel, QItemSelection

from PyQt5.QtCore import QModelIndex, QAbstractItemModel, Qt, pyqtSignal, QVariant, QObject
